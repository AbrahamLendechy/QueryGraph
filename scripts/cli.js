...
const contractABI = require("../artifacts/contracts/Querygraphthe.sol/Querygraphthe.json").abi;

program
    .name("querygraphthe-cli")
    .description("CLI tool for Querygraphthe smart contract")
    .version("1.0.0");
